...
public class ThiSinh {
    ...
    public String toString() {
        return "ThiSinh{" + "maThiSinh=" + maThiSinh + ", tenThiSinh='" + tenThiSinh + '\''
                + ", queQuan=" + queQuan + ", ngaySinh=" + ngaySinh + ", gioiTinh=" + gioiTinh
                + ", diemMon1=" + diemMon1 + ", diemMon2=" + diemMon2 + ", diemMon3=" + diemMon3
                + '}';
    }
    ...
    public boolean equals(Object obj) {
        ...
        return maThiSinh == other.maThiSinh && Objects.equals(tenThiSinh, other.tenThiSinh)
                && Objects.equals(queQuan, other.queQuan)
                && Objects.equals(ngaySinh, other.ngaySinh) && gioiTinh == other.gioiTinh
                && Float.floatToIntBits(diemMon1) == Float.floatToIntBits(other.diemMon1)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(maThiSinh, tenThiSinh, queQuan, ngaySinh, gioiTinh,
                Float.floatToIntBits(diemMon1), Float.floatToIntBits(diemMon2),
                Float.floatToIntBits(diemMon3));
    }
